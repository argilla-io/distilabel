...
-   :material-text-box-edit:{ .lg .middle } __TextGenerationWithCotReflection__

    ---

    Text generation with an `LLM` using Chain of Thought (CoT) reflection.

    [:octicons-arrow-right-24: TextGenerationWithCotReflection](textgenerationwithcotreflection.md){ .bottom }
