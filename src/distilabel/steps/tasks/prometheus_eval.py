...
class PrometheusEval(Task):
    ...
    inputs: List[str] = Field(
        ...
        description="The default inputs for the task are the 'instruction' and the 'generations' if `reference=False`, otherwise, `reference` is required.",
    )
    ...
    def model_post_init(self, __context: Any) -> None:
        ...
        self.inputs = self.inputs if self.reference else ["instruction", "generations"]
