...
class FormatTextGenerationSFT(Step):
    ...
    outputs: StepColumns = Field(
        default=["prompt", "prompt_id", "messages"],
        description="Format inspired in https://huggingface.co/datasets/HuggingFaceH4/ultrachat_200k",
    )
...
class FormatChatGenerationSFT(Step):
    ...
    inputs: StepColumns = ["messages", "generation"]
    outputs: StepColumns = ["prompt", "prompt_id", "messages"]
