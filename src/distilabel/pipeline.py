...
class Pipeline:
    ...
    def _build_dataset(  # noqa: C901
        ...
        if self.generator is not None and self.labeller is None:
            if self.generator.__type__ != "generation":  # type: ignore
                self.generator.__type__ = "generation"  # type: ignore
            _dataset.task = self.generator.task  # type: ignore
        elif self.labeller is not None:
            if self.labeller.__type__ != "labelling":  # type: ignore
                self.labeller.__type__ = "labelling"  # type: ignore
